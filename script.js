...
const QUESTION_BANK = [
  // Easy (4)
  new Question(
    "What is South Africa's most popular Bakkie?",
    ["Ford F450", "Toyota Hilux", "Mercedes-Benz X Class", "Ford Raptor"],
    1,
    "Easy",
  ),
  new Question(
    "What is the world's best-selling car of all time?",
    ["Ford F-150", "Toyota Corolla", "Volkswagen Golf Gti", "Honda Civic"],
    1,
    "Easy",
  ),
  new Question(
    "Which Volkswagen model is most common in South Africa?",
    ["Polo Vivo", "Golf 7 Gti", "Polo tsi", "Passat"],
    0,
    "Easy",
  ),
  new Question(
    "Which brand is not a German brand?",
    ["Porsche", "Hyundai", "BMW", "Mercedes"],
    1,
    "Easy",
  ),
  new Question(
  ...
  new Question(
    "Which brand is known for their 3 Series?",
  ...
  new Question(
    "Which car brand is native to the US market?",
  ...
  // Medium (10)
  new Question(
    "Which BMW model was created in 1982 that dominated multiple racing championships?",
    ["The E30 M3", "The E46 M3", "The M1", "The 325is"],
    0,
    "Medium",
  ),
  new Question(
    "Which company does NOT compete in motorsports?",
    ["Ford", "Rolls Royce", "Mercedes", "Audi"],
    1,
    "Medium",
  ),
  new Question(
    "What determines a sport car's overall performace?",
    ["Horsepower", "Weight to power ratio", "Grip", "Speed"],
    1,
    "Medium",
  ),
  new Question(
    "Where is the Nürburgring located?",
    ["Australia", "Germany", "South Africa", "United States of America"],
    1,
    "Medium",
  ),
  new Question(
  ...
  new Question(
    "What is the typical purpose of a turbocharger/supercharger?",
    [
  ...
  new Question(
    "What is the purpose of an electric motor in a sport cars?",
    [
      "Increases the weight of a car",
      "Makes the car faster",
      "Provides instant Torque",
      "Lowers the 0-60 time (0-100km/h)",
    ],
    2,
    "Medium",
  ),
  new Question(
    "What allows a car to spin its tires?",
    ["NOS", "High Horsepower", "Low Gross Vehicele Mass", "High Torque"],
    3,
    "Medium",
  ),
  ...
  // Difficult (10)
  new Question(
    "What is the MAIN purpouse of an altinator?",
    [
      "Charges the battery",
      "Powers all accessories of a car while running",
      "Controls Fuel/Air mixuture",
  ...
  new Question(
    "What is a the main purpouse of a differential (Diff)?",
    [
      "Controls the wheel speed",
      "Allows the wheels to rotate at diffrent speeds when turning",
      "Assist ABS (Anti-Lock Brake System)",
      "Allows the car to drift",
    ],
    1,
    "Difficult",
  ),
  ...
  new Question(
    "What issue did the founder of Lamborghini bring up to the founder of Ferrari?",
    [
      "The performance of the Ferrari 250 GT",
      "There was no issues",
      "Frustration with the clutch design",
      "A colaboration deal between the two brands",
    ],
    2,
    "Difficult",
  ),
  new Question(
    "What causes over steer?",
    [
      "When the rear wheels lose traction while turning",
      "Worn brake pads",
  ...
  new Question(
    ...
    [
      ...
      "When a FWD car loses traction during a corner",
      "Lowering a vehicles center of gravity",
    ],
    2,
    "Difficult",
  ),
  new Question(
    "What describes a turbocharged engine's delay in throttle response?",
    ["Detonation", "Turbo lag", "Engine braking", "Valve float"],
    1,
    "Difficult",
  ),
  new Question(
    "What are the three main things needed for an engine to run?",
    [
      "Battery, Altinator, fuse's",
      "Oil, Water, Air",
      "Fuel, Spark, Air",
      "Turbocharger, Air, Combustion",
    ],
    2,
    "Difficult",
  ),
  new Question(
    "What is the main function of a turbocharger?",
    [
      "Cool the intercooler",
      "Forces presurised air into the combustion chamber allowing for more fuel to be added, increasing power",
